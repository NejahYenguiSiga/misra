...
// Automatically set active nav item based on current path
(function initActiveNav(){
  function setActiveNav() {
    try {
      const rawPath = (window.location && window.location.pathname) ? window.location.pathname.toLowerCase() : '/index.html';
      const normalizedPath = (!rawPath || rawPath === '/') ? '/index.html' : rawPath;
      const links = document.querySelectorAll('#nav-menu a');
      links.forEach((link) => {
        const href = (link.getAttribute('href') || '').toLowerCase();
        const hrefNorm = href.startsWith('/') ? href : `/${href}`;
        if (hrefNorm === normalizedPath) link.classList.add('active');
...
const translations = {
  en: {
    'meta.title': 'Misra Group — Industrial Services & Divisions',
    'meta.description': 'Misra Group unites complementary industrial companies delivering reliable, compliant services. Explore our divisions: Zero Trace, Poultry, Olive and Export.',
    'nav.home': 'Home',
    'nav.about': 'About',
    'nav.services': 'Services',
    'nav.sectors': 'Sectors',
    'nav.cta': 'Contact Us',
    // Added explicit navbar items
    'nav.poultry': 'Poultry',
    'nav.olive': 'Olive',
    'nav.export': 'Export',
    ...
    'nav.contact': 'Contact',
    // Home (Misra Group)
    'hero.title': 'Misra Group — <span class="accent">Building Better</span> Industrial Operations.',
    'hero.subtitle': 'A group of specialized companies delivering reliable, compliant solutions across industries. We created Zero Trace to solve our own high‑stakes cleaning needs—now we bring the same standard to everyone we serve.',
    'hero.ctaPrimary': '✉️ Contact Us',
    'hero.ctaSecondary': 'Explore Divisions',
    ...
    'about.desc': 'Misra Group unites complementary industrial services under one roof—designed for measurable results, compliance, and operational certainty. Zero Trace began as our in‑house solution for no‑trace cleaning and sanitization, and grew into a dedicated division serving external clients with the same rigor.',
    ...
    // Divisions
    'services.title': 'Our <span class="accent">Divisions</span>',
    'services.intro': 'Specialized companies within Misra Group. Details live on each division page.',
    'services.s1.title': 'Zero Trace — Cleaning & Sanitization',
    'services.s1.desc': 'Compliance-first industrial cleaning, disinfection and odor control with measurable outcomes.',
    'services.s2.title': 'Poultry — Agri Services',
    'services.s2.desc': 'Biosecurity-first programs and support tailored for poultry operations.',
    'services.s3.title': 'Olive — Press Operations Support',
    'services.s3.desc': 'Residue removal, hygiene and process support around olive‑oil operations.',
    'services.s4.title': 'Export — Logistics & Trade',
    'services.s4.desc': 'Safe, reliable export, documentation and logistics enablement.',
    'services.s5.title': 'Emergency Response',
    'services.s5.desc': 'Rapid mobilization and containment across group competencies.',
  ...
  fr: {
    'meta.title': 'Misra Group — Services industriels & divisions',
    'meta.description': 'Misra Group réunit des entreprises industrielles complémentaires offrant des services fiables et conformes. Découvrez nos divisions : Zero Trace, Avicole, Huileries et Export.',
    ...
    'nav.contact': 'Contact',
    // Accueil (Misra Group)
    'hero.title': 'Misra Group — <span class="accent">Mieux construire</span> des opérations industrielles.',
    'hero.subtitle': 'Un groupe d\'entreprises spécialisées offrant des solutions fiables et conformes. Nous avons créé Zero Trace pour résoudre nos propres besoins critiques en nettoyage — nous appliquons aujourd\'hui le même standard à tous nos clients.',
    'hero.ctaPrimary': '✉️ Contactez‑nous', 'hero.ctaSecondary': 'Découvrir les divisions', 'hero.badgeEco': 'Écoresponsable', 'hero.badgeCompliance': 'Conformité', 'hero.badgeFast': 'Intervention rapide',
    // À propos du groupe
    'about.title': 'À propos de <span class="accent">Misra Group</span>',
    'about.desc': 'Misra Group réunit des services industriels complémentaires — pensés pour des résultats mesurables, la conformité et la fiabilité opérationnelle. Zero Trace a commencé comme solution interne de nettoyage « sans trace », et est devenue une division dédiée au service des clients externes avec la même rigueur.',
    ...
    // Divisions
    'services.title': 'Nos <span class="accent">Divisions</span>', 'services.intro': 'Des sociétés spécialisées au sein de Misra Group. Les détails sont sur chaque page division.',
    'services.s1.title': 'Zero Trace — Nettoyage & assainissement', 'services.s1.desc': 'Nettoyage industriel conforme, désinfection et contrôle des odeurs avec résultats mesurables.',
    'services.s2.title': 'Avicole — Services agro', 'services.s2.desc': 'Programmes de biosécurité et accompagnement pour les élevages.',
    'services.s3.title': 'Huileries — Support d\'exploitation', 'services.s3.desc': 'Décrassage, hygiène et support process autour des huileries.',
    'services.s4.title': 'Export — Logistique & commerce', 'services.s4.desc': 'Export sûr et fiable, documentation et logistique.',
    'services.s5.title': 'Intervention d\'urgence', 'services.s5.desc': 'Mobilisation et confinement rapides à l\'échelle du groupe.',
    'sectors.title': 'Secteurs que nous <span class="accent">servons</span>',
    'sectors.s1.title': 'Élevages avicoles', 'sectors.s1.desc': 'Biosécurité prioritaire pour contrôler pathogènes et contaminations croisées.',
    'sectors.s2.title': 'Huileries', 'sectors.s2.desc': 'Élimination des résidus et huiles en protégeant le milieu alimentaire.',
    'sectors.s3.title': 'Hôtels', 'sectors.s3.desc': 'Nettoyage de fond et désinfection côté front office.',
    'sectors.s4.title': 'Sites de déchets municipaux', 'sectors.s4.desc': 'Suppression des odeurs et décontamination pour sites à forte charge.',
    'clients.title': 'Nos <span class=\"accent\">Clients</span>', 'clients.intro': 'Nombreux acteurs de l\'agriculture, de l\'hôtellerie et du public nous font confiance.',
  ...
  es: {
    'meta.title': 'Misra Group — Servicios industriales y divisiones',
    'meta.description': 'Misra Group reúne empresas industriales complementarias que brindan servicios fiables y conformes. Explora nuestras divisiones: Zero Trace, Avícola, Oliva y Exportación.',
    ...
    // Inicio (Misra Group)
    'hero.title': 'Misra Group — <span class="accent">Impulsando</span> operaciones industriales.',
    'hero.subtitle': 'Un grupo de empresas especializadas que entrega soluciones fiables y conformes. Creamos Zero Trace para cubrir nuestras propias necesidades críticas de limpieza — ahora llevamos ese estándar a todos los clientes.',
    'hero.ctaPrimary': '✉️ Contáctanos', 'hero.ctaSecondary': 'Explorar divisiones', 'hero.badgeEco': 'Ecológico', 'hero.badgeCompliance': 'Conformidad', 'hero.badgeFast': 'Respuesta rápida',
    // Sobre el grupo
    'about.title': 'Sobre <span class="accent">Misra Group</span>',
    'about.desc': 'Misra Group reúne servicios industriales complementarios con enfoque en resultados medibles, conformidad y certeza operativa. Zero Trace nació como solución interna de limpieza sin rastro y creció hasta ser una división dedicada para clientes externos.',
    'about.point1': 'Métodos ecológicos', 'about.point2': 'Protocolos y reportes', 'about.point3': 'Equipo industrial y EPP', 'about.point4': 'Despliegue rápido',
    // Divisiones
    'services.title': 'Nuestras <span class="accent">Divisiones</span>', 'services.intro': 'Empresas especializadas dentro de Misra Group. Detalles en cada página.',
    'services.s1.title': 'Zero Trace — Limpieza y sanitización', 'services.s1.desc': 'Limpieza industrial conforme, desinfección y control de olores con resultados medibles.',
    'services.s2.title': 'Avícola — Servicios agro', 'services.s2.desc': 'Programas de bioseguridad y soporte para operaciones avícolas.',
    'services.s3.title': 'Oliva — Soporte a almazaras', 'services.s3.desc': 'Eliminación de residuos, higiene y soporte de proceso en almazaras.',
    'services.s4.title': 'Exportación — Logística y comercio', 'services.s4.desc': 'Exportación segura y confiable, documentación y logística.',
    'services.s5.title': 'Respuesta de emergencia', 'services.s5.desc': 'Movilización y contención rápidas a nivel del grupo.',
    'sectors.title': 'Sectores que <span class="accent">atendemos</span>', 'sectors.s1.title': 'Granjas avícolas', 'sectors.s1.desc': 'Bioseguridad para controlar patógenos y contaminación cruzada.', 'sectors.s2.title': 'Almazaras', 'sectors.s2.desc': 'Eliminación de residuos y aceites protegiendo entornos alimentarios.', 'sectors.s3.title': 'Hoteles', 'sectors.s3.desc': 'Limpieza profunda interna y desinfección de áreas públicas.', 'sectors.s4.title': 'Residuos municipales', 'sectors.s4.desc': 'Supresión de olores y descontaminación para sitios de alta carga.',
    ...
    // Insights + FAQ
    'insights.eyebrow': 'Contenido', 'insights.title': 'Guías y buenas prácticas', 'insights.intro': 'Métodos prácticos y verificables para entornos industriales.', 'insights.a1.title': 'Pruebas ATP para sanitización: umbrales y reportes', 'insights.a1.desc': 'Por qué importa el ATP, cómo muestreamos y rangos objetivo en áreas de alto riesgo.', 'insights.a1.cta': 'Hablar con un experto', 'insights.a2.title': 'Control de olores en residuos municipales: guía práctica', 'insights.a2.desc': 'Identificación de fuentes, química de neutralización y métricas medibles.', 'insights.a2.cta': 'Solicitar la SOP completa',
    'faq.eyebrow': 'FAQ', 'faq.title': 'Preguntas frecuentes', 'faq.q1': '¿Qué sectores atendéis?', 'faq.a1': 'Recolectamos y pre‑tratamos residuos de granjas avícolas, almazaras y sitios municipales. Los hoteles también son clientes.', 'faq.q2': '¿Ofrecen respuesta a derrames (emergencias)?', 'faq.a2': 'Sí. Contención rápida y retiro conforme ante derrames o incidentes.', 'faq.q3': '¿Cómo pedimos un presupuesto?', 'faq.a3': 'Use el formulario o escriba a contact@zerotrace.tn. Respondemos en 1 día.'
  },
  de: {
    'meta.title': 'Misra Group — Industriedienstleistungen & Divisionen',
    'meta.description': 'Misra Group vereint komplementäre Industrieunternehmen mit zuverlässigen, konformen Services. Entdecken Sie unsere Divisionen: Zero Trace, Geflügel, Oliven und Export.',
    ...
    'nav.olive': 'Olivenpressen',
    'nav.export': 'Export',
    'nav.zerotrace': 'Zero Trace',
    'nav.contact': 'Kontakt',
    // Startseite (Misra Group)
    'hero.title': 'Misra Group — <span class="accent">Bessere</span> Industrieprozesse.',
    'hero.subtitle': 'Eine Gruppe spezialisierter Unternehmen mit zuverlässigen, konformen Lösungen. Zero Trace entstand, um unsere eigenen Reinigungsanforderungen zu lösen — heute gilt derselbe Standard für alle Kunden.',
    'hero.ctaPrimary': '✉️ Kontakt aufnehmen', 'hero.ctaSecondary': 'Divisionen ansehen', 'hero.badgeEco': 'Umweltbewusst', 'hero.badgeCompliance': 'Konform', 'hero.badgeFast': 'Schnelle Reaktion',
    // Über den Konzern
    'about.title': 'Über <span class="accent">Misra Group</span>',
    'about.desc': 'Misra Group vereint komplementäre Industriedienstleistungen — ausgerichtet auf messbare Ergebnisse, Compliance und Betriebssicherheit. Zero Trace startete als interne Lösung für spurenloses Reinigen und ist heute eine eigene Division für externe Kunden.',
    'about.point1': 'Umweltfreundliche Methoden', 'about.point2': 'Konforme Protokolle', 'about.point3': 'Industrieausrüstung & PSA', 'about.point4': 'Schneller Einsatz',
    // Divisionen
    'services.title': 'Unsere <span class="accent">Divisionen</span>', 'services.intro': 'Spezialisierte Unternehmen innerhalb der Misra Group. Details auf den Divisionsseiten.',
    'services.s1.title': 'Zero Trace — Reinigung & Hygiene', 'services.s1.desc': 'Konforme Industriereinigung, Desinfektion und Geruchskontrolle mit messbaren Ergebnissen.',
    'services.s2.title': 'Geflügel — Agrarservices', 'services.s2.desc': 'Biosicherheitsprogramme und Support für Geflügelbetriebe.',
    'services.s3.title': 'Oliven — Unterstützung für Pressen', 'services.s3.desc': 'Rückstandsentfernung, Hygiene und Prozesssupport rund um Olivenpressen.',
    'services.s4.title': 'Export — Logistik & Handel', 'services.s4.desc': 'Sicherer Export, Dokumentation und Logistik.',
    'services.s5.title': 'Notfalleinsätze', 'services.s5.desc': 'Schnelle Mobilisierung und Eindämmung im Konzernverbund.',
    'sectors.title': 'Branchen, die wir <span class="accent">bedienen</span>', 'sectors.s1.title': 'Geflügelfarmen', 'sectors.s1.desc': 'Biosicherheit zur Kontrolle von Keimen und Kreuzkontamination.', 'sectors.s2.title': 'Olivenölpressen', 'sectors.s2.desc': 'Entfernung von Rückständen unter Schutz von Lebensmittelumgebungen.', 'sectors.s3.title': 'Hotels', 'sectors.s3.desc': 'Grundreinigung back-of-house und Desinfektion front-of-house.', 'sectors.s4.title': 'Kommunale Abfallplätze', 'sectors.s4.desc': 'Geruchsminderung und Dekontamination für stark belastete Standorte.',
    ...
    // Insights + FAQ
    'insights.eyebrow': 'Einblicke', 'insights.title': 'Leitfäden & Best Practices', 'insights.intro': 'Praktische, überprüfbare Methoden für Industrieumgebungen.', 'insights.a1.title': 'ATP-Tests für Hygiene: Schwellen und Reporting', 'insights.a1.desc': 'Warum ATP wichtig ist, Probenahme und Zielbereiche für Risiko-Zonen.', 'insights.a1.cta': 'Mit Expertin/Experten sprechen', 'insights.a2.title': 'Geruchskontrolle auf kommunalen Deponien: Leitfaden', 'insights.a2.desc': 'Quellidentifikation, Neutralisationschemie und messbare Kennzahlen.', 'insights.a2.cta': 'Vollständige SOP anfordern',
    'faq.eyebrow': 'FAQ', 'faq.title': 'Häufige Fragen', 'faq.q1': 'Welche Branchen bedienen Sie?', 'faq.a1': 'Wir sammeln und vorbehandeln Abfälle von Geflügelfarmen, Olivenölpressen und kommunalen Standorten. Hotels sind ebenfalls Kunden.', 'faq.q2': 'Bieten Sie Notfall‑Einsätze bei Leckagen/Unfällen an?', 'faq.a2': 'Ja, schnelle Eindämmung und konformer Abtransport bei Vorfällen.', 'faq.q3': 'Wie fordern wir ein Angebot an?', 'faq.a3': 'Über das Formular oder an contact@zerotrace.tn. Antwort in 1 Werktag.'
  },
  ar: {
    'meta.title': 'مجموعة ميسرا — خدمات صناعية وأقسام',
    'meta.description': 'تجمع مجموعة ميسرا شركات صناعية متكاملة تقدم خدمات موثوقة ومتوافقة. اكتشف أقسامنا: زيرو تريس، الدواجن، الزيتون والتصدير.',
    ...
    'nav.contact': 'اتصال',
    // الصفحة الرئيسية (مجموعة ميسرا)
    'hero.title': 'مجموعة ميسرا — <span class="accent">نرتقي</span> بالعمليات الصناعية.',
    'hero.subtitle': 'مجموعة من الشركات المتخصصة تقدم حلولًا موثوقة ومتوافقة. أنشأنا زيرو تريس لحل احتياجاتنا الداخلية عالية الأهمية في التنظيف — ونقدم اليوم نفس المعيار لجميع العملاء.',
    'hero.ctaPrimary': '✉️ اتصل بنا', 'hero.ctaSecondary': 'استكشف الأقسام', 'hero.badgeEco': 'صديق للبيئة', 'hero.badgeCompliance': 'امتثال', 'hero.badgeFast': 'استجابة سريعة',
    // عن المجموعة
    'about.title': 'عن <span class="accent">مجموعة ميسرا</span>', 'about.desc': 'توحد مجموعة ميسرا خدمات صناعية متكاملة — لتحقيق نتائج قابلة للقياس والامتثال والاعتمادية التشغيلية. بدأت زيرو تريس كحل داخلي للتنظيف بلا أثر وأصبحت قسمًا متخصصًا يخدم العملاء الخارجيين بنفس الصرامة.', 'about.point1': 'أساليب علمية صديقة للبيئة', 'about.point2': 'بروتوكولات وتقارير امتثال', 'about.point3': 'معدات ووسائل حماية صناعية', 'about.point4': 'استجابة سريعة وجدولة منتظمة',
    // الأقسام
    'services.title': 'أقسامنا <span class="accent">الرئيسية</span>', 'services.intro': 'شركات متخصصة ضمن مجموعة ميسرا. التفاصيل في صفحات الأقسام.',
    'services.s1.title': 'زيرو تريس — تنظيف وتعقيم', 'services.s1.desc': 'تنظيف صناعي متوافق، تعقيم، والتحكم بالروائح بنتائج قابلة للقياس.',
    'services.s2.title': 'الدواجن — خدمات زراعية', 'services.s2.desc': 'برامج حيوية للسلامة ودعم لمزارع الدواجن.',
    'services.s3.title': 'الزيتون — دعم المعاصر', 'services.s3.desc': 'إزالة المخلفات، النظافة ودعم العمليات حول المعاصر.',
    'services.s4.title': 'التصدير — لوجستيات وتجارة', 'services.s4.desc': 'تصدير آمن وموثوق، مستندات ولوجستيات.',
    'services.s5.title': 'الاستجابة للطوارئ', 'services.s5.desc': 'تعبئة واحتواء سريع عبر قدرات المجموعة.',
    'sectors.title': 'القطاعات التي <span class="accent">نخدمها</span>', 'sectors.s1.title': 'مزارع الدواجن', 'sectors.s1.desc': 'برامج حيوية للسلامة للحد من مسببات الأمراض والعدوى المتقاطعة.', 'sectors.s2.title': 'معاصر الزيتون', 'sectors.s2.desc': 'إزالة الرواسب والزيوت مع حماية بيئات الغذاء.', 'sectors.s3.title': 'الفنادق', 'sectors.s3.desc': 'تنظيف عميق للمناطق الخلفية وتعقيم للمناطق الأمامية.', 'sectors.s4.title': 'مواقع النفايات البلدية', 'sectors.s4.desc': 'كبح الروائح وإزالة التلوث للمواقع ذات الحمل العالي.',
    ...
    // Insights + FAQ
    'insights.eyebrow': 'مقالات', 'insights.title': 'إرشادات وأفضل الممارسات', 'insights.intro': 'أساليب عملية وموثوقة نستخدمها في البيئات الصناعية.', 'insights.a1.title': 'اختبار ATP للتعقيم: الحدود والتقارير', 'insights.a1.desc': 'أهمية ATP، كيفية أخذ العينات، ونطاقات القبول في المناطق عالية الخطورة.', 'insights.a1.cta': 'تحدث إلى خبير', 'insights.a2.title': 'مكافحة الروائح في مواقع النفايات البلدية: دليل عملي', 'insights.a2.desc': 'تحديد المصدر، كيمياء التعادل، ومقاييس كبح قابلة للقياس.', 'insights.a2.cta': 'اطلب إجراءات التشغيل القياسية الكاملة',
    'faq.eyebrow': 'الأسئلة الشائعة', 'faq.title': 'أسئلة متكررة', 'faq.q1': 'ما القطاعات التي تخدمونها؟', 'faq.a1': 'نجمع وننقل ونعالج أوليًا نفايات مزارع الدواجن ومعاصر الزيتون والمواقع البلدية.', 'faq.q2': 'هل تقدمون استجابة طارئة لحوادث/تسربات؟', 'faq.a2': 'نعم، احتواء سريع وإزالة متوافقة في حال الحوادث أو التسربات.', 'faq.q3': 'كيف نطلب عرض سعر؟', 'faq.a3': 'عبر النموذج أو البريد contact@zerotrace.tn. نرد خلال يوم عمل.'
  }
};
...
function applyTranslationsFor(lang) {
  ...
  const updates = [
    ...
    // Navbar items (6 items)
    { sel: '#nav-menu li:nth-child(1) a', key: 'nav.home' },
    { sel: '#nav-menu li:nth-child(2) a', key: 'nav.poultry' },
    { sel: '#nav-menu li:nth-child(3) a', key: 'nav.olive' },
    { sel: '#nav-menu li:nth-child(4) a', key: 'nav.export' },
    { sel: '#nav-menu li:nth-child(5) a', key: 'nav.zerotrace' },
    { sel: '#nav-menu li:nth-child(6) a', key: 'nav.contact' },
